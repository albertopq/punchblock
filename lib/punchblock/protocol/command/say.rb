  ...
  class Protocol
    module Command
      class Say < CommandNode
        ...
        #
        # @return [Command::Say] an Ozone "say" command
        #
        # @example
        ...
        #
        # @return [Command::Say::Pause] an Ozone pause message for the current Say
        #
        # @example
        ...
        #
        # @return [Command::Say::Resume] an Ozone resume message
        #
        # @example
        ...
        #
        # @return [Command::Say::Stop] an Ozone stop message
        #
        # @example
