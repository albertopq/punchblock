  ...
  class Protocol
    module Command
      class Conference < CommandNode
        ...
        #
        # @return [Command::Conference] a formatted Ozone conference command
        #
        # @example
        ...
        #
        # @return [Command::Conference::Mute] an Ozone mute message
        #
        # @example
        ...
        #
        # @return [Command::Conference::Unmute] an Ozone unmute message
        #
        # @example
        ...
        #
        # @return [Command::Conference::Stop] an Ozone conference stop message
        #
        # @example
        ...
        #
        # @return [Command::Conference::Kick] an Ozone conference kick message
        #
        # @example
