        ...
        describe "actions" do
          ...
          describe '#mute!' do
            describe "when unmuted" do
              ...
              it "should send its command properly" do
                conference.connection.expects(:write).with('123abc', conference.mute_action, 'abc123').returns true
          ...
          describe '#unmute!' do
            ...
            describe "when muted" do
              ...
              it "should send its command properly" do
                conference.connection.expects(:write).with('123abc', conference.unmute_action, 'abc123').returns true
          ...
          describe '#stop!' do
            describe "when the command is executing" do
              ...
              it "should send its command properly" do
                conference.connection.expects(:write).with('123abc', conference.stop_action, 'abc123')
                conference.stop!
              end
            end
          ...
          describe '#kick!' do
            describe "when the command is executing" do
              ...
              it "should send its command properly" do
                conference.connection.expects(:write).with('123abc', conference.kick_action(:message => 'bye!'), 'abc123')
